import { c as Cu } from './_commonjsHelpers-de833af9.js';
function oe(u, e) {
	for (var D = -1, A = u == null ? 0 : u.length, s = Array(A); ++D < A; ) s[D] = e(u[D], D, u);
	return s;
}
var Ee = oe;
function ce() {
...
var Xu = pe,
	le = Xu;
function fe(u, e) {
	for (var D = u.length; D--; ) if (le(u[D][0], e)) return D;
	return -1;
}
var Bu = fe,
	he = Bu,
...
var Ke = We,
	qe = typeof Cu == 'object' && Cu && Cu.Object === Object && Cu,
	ue = qe,
	Ve = ue,
	...
	$u = lu,
	ee = Object.prototype,
	Xe = ee.hasOwnProperty,
	u0 = ee.toString,
	tu = $u ? $u.toStringTag : void 0;
function e0(u) {
	var e = Xe.call(u, tu),
		D = u[tu];
	try {
...
var gr = Y,
	...
	xr = Nu;
function mr() {
	(this.size = 0), (this.__data__ = { hash: new ku(), map: new (xr || vr)(), string: new ku() });
}
var _r = mr;
function Tr(u) {
	var e = typeof u;
...
function Zr(u, e) {
	...
	if (D instanceof Vr) {
		var A = D.__data__;
		if (!Qr || A.length < Yr - 1) return A.push([u, e]), (this.size = ++D.size), this;
...
function ou(u) {
	var e = -1,
		D = u == null ? 0 : u.length;
	for (this.__data__ = new Ct(); ++e < D; ) this.add(u[e]);
}
ou.prototype.add = ou.prototype.push = ot;
ou.prototype.has = Et;
var ct = ou;
function Bt(u, e) {
	for (var D = -1, A = u == null ? 0 : u.length; ++D < A; ) if (e(u[D], D, u)) return !0;
	return !1;
}
var pt = Bt;
function lt(u, e) {
...
function xt(u, e, D, A, s, F) {
	var t = D & gt,
		l = u.length,
		g = e.length;
	if (l != g && !(t && g > l)) return !1;
	var x = F.get(u),
		R = F.get(e);
	if (x && R) return x == e && R == u;
	var S = -1,
		o = !0,
		v = D & vt ? new ht() : void 0;
	for (F.set(u, e), F.set(e, u); ++S < l; ) {
		var y = u[S],
			E = e[S];
		if (A) var p = t ? A(E, y, S, e, u, F) : A(y, E, S, u, e, F);
		if (p !== void 0) {
			if (p) continue;
			o = !1;
			break;
		...
		if (v) {
			if (
				!dt(e, function (P, k) {
					if (!yt(v, k) && (y === P || s(y, P, D, A, F))) return v.push(k);
				})
			) {
				o = !1;
				break;
...
var Ot = wt,
	...
	Qt = '[object DataView]',
	Uu = Mu ? Mu.prototype : void 0,
	xu = Uu ? Uu.valueOf : void 0;
function Jt(u, e, D, A, s, F, t) {
	switch (D) {
		...
		case Wt:
			var g = A & Lt;
			if ((l || (l = Pt), u.size != e.size && !g)) return !1;
			var x = t.get(u);
			if (x) return x == e;
			(A |= kt), t.set(u, e);
...
var aa = ta,
	...
	Da = du,
	ae = Object.prototype,
	na = ae.hasOwnProperty,
	ia = ae.propertyIsEnumerable,
	sa = Gu(
		(function () {
			return arguments;
		})()
...
var Wa = cu.exports,
	...
	pD = uu(Su),
	q = De;
((mu && q(new mu(new ArrayBuffer(1))) != Qu) ||
	(_u && q(new _u()) != Wu) ||
	(Tu && q(Tu.resolve()) != Ku) ||
	(bu && q(new bu()) != qu) ||
	(Su && q(new Su()) != Vu)) &&
...
var TD = _D,
	...
	RD = yD,
	ID = 1 / 0,
	Yu = Ju ? Ju.prototype : void 0,
	Zu = Yu ? Yu.toString : void 0;
function ie(u) {
	if (typeof u == 'string') return u;
	if ($D(u)) return OD(u, ie) + '';
	if (RD(u)) return Zu ? Zu.call(u) : '';
	var e = u + '';
...
(function () {
	...
	function F(t) {
		var l;
		if (t.type !== 'IfStatement' || t.alternate == null) return !1;
		l = t.consequent;
		do {
...
(function () {
	...
	function S(p) {
		...
		var P = String.fromCharCode(Math.floor((p - 65536) / 1024) + 55296),
...
(function () {
	...
	function l(o) {
		var v, y, E;
		if (o.length === 0 || ((E = o.charCodeAt(0)), !u.isIdentifierStartES5(E))) return !1;
		for (v = 1, y = o.length; v < y; ++v)
			if (((E = o.charCodeAt(v)), !u.isIdentifierPartES5(E))) return !1;
		return !0;
	}
	function g(o, v) {
	...
	function x(o) {
		...
		for (P = u.isIdentifierStartES6, v = 0, y = o.length; v < y; ++v) {
			if (((E = o.charCodeAt(v)), 55296 <= E && E <= 56319)) {
				if ((++v, v >= y || ((p = o.charCodeAt(v)), !(56320 <= p && p <= 57343)))) return !1;
				E = g(E, p);
			}
			if (!P(E)) return !1;
...
const UD = 'doctrine',
	GD = 'JSDoc parser',
	zD = 'https://github.com/eslint/doctrine',
	HD = 'lib/doctrine.js',
	WD = '3.0.0',
	KD = { node: '>=6.0.0' },
	qD = { lib: './lib' },
...
`;
						...
						default:
							g.code.isOctalDigit(f.charCodeAt(0))
								? ((i = '01234567'.indexOf(f)),
								  s < A &&
										g.code.isOctalDigit(D.charCodeAt(s)) &&
	...
	function k() {
		...
		if (((r = ''), (a = D.charCodeAt(s)), a !== 46)) {
			if (((r = E()), (a = D.charCodeAt(s)), r === '0')) {
				if (a === 120 || a === 88) {
					for (r += E(); s < A && ((a = D.charCodeAt(s)), !!g.code.isHexDigit(a)); ) r += E();
					return (
						r.length <= 2 && x.throwError('unexpected token'),
						s < A &&
							((a = D.charCodeAt(s)),
							g.code.isIdentifierStartES5(a) && x.throwError('unexpected token')),
						(l = parseInt(r, 16)),
						e.NUMBER
					);
				}
				if (g.code.isOctalDigit(a)) {
					for (r += E(); s < A && ((a = D.charCodeAt(s)), !!g.code.isOctalDigit(a)); ) r += E();
					return (
						s < A &&
							((a = D.charCodeAt(s)),
							(g.code.isIdentifierStartES5(a) || g.code.isDecimalDigit(a)) &&
			...
			for (; s < A && ((a = D.charCodeAt(s)), !!g.code.isDecimalDigit(a)); ) r += E();
		}
		if (a === 46)
			for (r += E(); s < A && ((a = D.charCodeAt(s)), !!g.code.isDecimalDigit(a)); ) r += E();
		if (a === 101 || a === 69)
			if (
				((r += E()),
				(a = D.charCodeAt(s)),
				(a === 43 || a === 45) && (r += E()),
				(a = D.charCodeAt(s)),
				g.code.isDecimalDigit(a))
			)
				for (r += E(); s < A && ((a = D.charCodeAt(s)), !!g.code.isDecimalDigit(a)); ) r += E();
			else x.throwError('unexpected token');
		return (
			s < A &&
				((a = D.charCodeAt(s)), g.code.isIdentifierStartES5(a) && x.throwError('unexpected token')),
			(l = parseFloat(r)),
			e.NUMBER
		);
	}
	function iu() {
		...
		for (l = E(); s < A && o(D.charCodeAt(s)); ) {
			if (((r = D.charCodeAt(s)), r === 46)) {
				...
				if (((a = D.charCodeAt(s + 1)), a === 60)) break;
			}
			l += E();
		}
		return e.NAME;
	...
	function M() {
		var r;
		for (F = s; s < A && g.code.isWhiteSpace(D.charCodeAt(s)); ) E();
		if (s >= A) return (t = e.EOF), t;
		switch (((r = D.charCodeAt(s)), r)) {
			...
			case 46:
				if (s + 1 < A) {
					if (((r = D.charCodeAt(s + 1)), r === 60)) return E(), E(), (t = e.DOT_LT), t;
					if (r === 46 && s + 2 < A && D.charCodeAt(s + 2) === 46)
						return E(), E(), E(), (t = e.REST), t;
					if (g.code.isDecimalDigit(r)) return (t = k()), t;
				}
	...
	function I() {
		...
		if ((m(e.LPAREN, 'UnionType should start with ('), (r = []), t !== e.RPAREN))
			for (; r.push(L()), t !== e.RPAREN; ) C(e.PIPE);
		return (
			m(e.RPAREN, 'UnionType should end with )'), y({ type: u.UnionType, elements: r }, [a, F])
		);
	}
	function c() {
		var r,
		...
		for (m(e.LBRACK, 'ArrayType should start with ['), r = []; t !== e.RBRACK; ) {
			if (t === e.REST) {
				(f = s - 3), m(e.REST), r.push(y({ type: u.RestType, expression: L() }, [f, F]));
				break;
			} else r.push(L());
			t !== e.RBRACK && C(e.COMMA);
		}
		return C(e.RBRACK), y({ type: u.ArrayType, elements: r }, [a, F]);
	}
	function j() {
		var r = l;
		if (t === e.NAME || t === e.STRING) return M(), r;
		if (t === e.NUMBER) return m(e.NUMBER), String(r);
		x.throwError('unexpected token');
	}
	function U() {
		var r,
		...
		return (
			(r = j()),
			t === e.COLON
				? (m(e.COLON), y({ type: u.FieldType, key: r, value: L() }, [a, F]))
				: y({ type: u.FieldType, key: r, value: null }, [a, F])
		);
	}
	function d() {
		var r,
			a = s - 1,
			f;
		if ((m(e.LBRACE, 'RecordType should start with {'), (r = []), t === e.COMMA)) m(e.COMMA);
		else for (; t !== e.RBRACE; ) r.push(U()), t !== e.RBRACE && C(e.COMMA);
		return (f = s), C(e.RBRACE), y({ type: u.RecordType, fields: r }, [a, f]);
	}
	function eu() {
		var r = l,
			a = s - r.length;
		return (
			...
			t === e.COLON &&
				...
				(m(e.COLON), (r += ':' + l), C(e.NAME)),
			y({ type: u.NameExpression, name: r }, [a, F])
		);
	}
	function su() {
		var r = [];
		for (r.push(G()); t === e.COMMA; ) m(e.COMMA), r.push(G());
		return r;
	}
	function W() {
		var r,
		...
		return (
			...
			t === e.DOT_LT || t === e.LT
				? (M(),
				  (a = su()),
				  C(e.GT),
				  y({ type: u.TypeApplication, expression: r, applications: a }, [f, F]))
				: r
		);
	}
	function Au() {
		return (
			...
			t === e.NAME && l === 'void' ? (m(e.NAME), { type: u.VoidLiteral }) : L()
		);
	}
	function b() {
		for (var r = [], a = !1, f, i = !1, n, B = s - 3, h; t !== e.RPAREN; )
			t === e.REST && (m(e.REST), (i = !0)),
				(n = F),
				(f = L()),
				f.type === u.NameExpression &&
					...
					((h = F - f.name.length),
					m(e.COLON),
					(f = y({ type: u.ParameterType, name: f.name, expression: L() }, [h, F]))),
				t === e.EQUAL
					? (m(e.EQUAL), (f = y({ type: u.OptionalType, expression: f }, [n, F])), (a = !0))
					: a && x.throwError('unexpected token'),
				i && (f = y({ type: u.RestType, expression: f }, [B, F])),
				r.push(f),
				t !== e.RPAREN && C(e.COMMA);
		return r;
	}
	function yu() {
		var r,
			...
			B = s - l.length;
		return (
			x.assert(t === e.NAME && l === 'function', "FunctionType should start with 'function'"),
			m(e.NAME),
			C(e.LPAREN),
			(r = !1),
			(f = []),
			(a = null),
			t !== e.RPAREN &&
				(t === e.NAME && (l === 'this' || l === 'new')
					? ((r = l === 'new'),
					  m(e.NAME),
					  C(e.COLON),
					  (a = W()),
					  t === e.COMMA && (m(e.COMMA), (f = b())))
					: (f = b())),
			C(e.RPAREN),
			(i = null),
			t === e.COLON && (i = Au()),
			(n = y({ type: u.FunctionType, params: f, result: i }, [B, F])),
			a && ((n.this = a), r && (n.new = !0)),
			n
		);
	}
	function ru() {
		...
		switch (t) {
			case e.STAR:
				return m(e.STAR), y({ type: u.AllLiteral }, [F - 1, F]);
			case e.LPAREN:
				return I();
			case e.LBRACK:
				return c();
			...
			case e.NAME:
				if (((a = s - l.length), l === 'null'))
					return m(e.NAME), y({ type: u.NullLiteral }, [a, F]);
				if (l === 'undefined') return m(e.NAME), y({ type: u.UndefinedLiteral }, [a, F]);
				if (l === 'true' || l === 'false')
					return m(e.NAME), y({ type: u.BooleanLiteralType, value: l === 'true' }, [a, F]);
				...
				return W();
			case e.STRING:
				return M(), y({ type: u.StringLiteralType, value: l }, [F - l.length - 2, F]);
			case e.NUMBER:
				return M(), y({ type: u.NumericLiteralType, value: l }, [F - String(l).length, F]);
			default:
				x.throwError('unexpected token');
		}
	}
	function L() {
		...
		return t === e.QUESTION
			? ((a = s - 1),
			  ...
			  t === e.RBRACK ||
			  t === e.GT
					? y({ type: u.NullableLiteral }, [a, F])
					: y({ type: u.NullableType, expression: ru(), prefix: !0 }, [a, F]))
			: t === e.BANG
			? ((a = s - 1),
			  m(e.BANG),
			  y({ type: u.NonNullableType, expression: ru(), prefix: !0 }, [a, F]))
			: ((a = F),
			  (r = ru()),
			  t === e.BANG
					? (m(e.BANG), y({ type: u.NonNullableType, expression: r, prefix: !1 }, [a, F]))
					: t === e.QUESTION
					? (m(e.QUESTION), y({ type: u.NullableType, expression: r, prefix: !1 }, [a, F]))
					: t === e.LBRACK
					? (m(e.LBRACK),
					  ...
					  y(
							{
								...
								expression: y({ type: u.NameExpression, name: 'Array' }, [a, F]),
								applications: [r]
							},
							[a, F]
					  ))
	...
	function G() {
		var r, a;
		if (((r = L()), t !== e.PIPE)) return r;
		for (a = [r], m(e.PIPE); a.push(L()), t === e.PIPE; ) m(e.PIPE);
		return y({ type: u.UnionType, elements: a }, [0, s]);
	}
	function K() {
		var r;
		return t === e.REST
			? (m(e.REST), y({ type: u.RestType, expression: G() }, [0, s]))
			: ((r = G()),
			  t === e.EQUAL ? (m(e.EQUAL), y({ type: u.OptionalType, expression: r }, [0, s])) : r);
	}
	function Fu(r, a) {
		var f;
		return (
	...
	function N(r, a, f) {
		...
		switch (r.type) {
			...
			case u.FunctionType:
				for (
					i = a ? 'function(' : 'function (',
						r.this &&
							(r.new ? (i += a ? 'new:' : 'new: ') : (i += a ? 'this:' : 'this: '),
							(i += N(r.this, a)),
							r.params.length !== 0 && (i += a ? ',' : ', ')),
						n = 0,
						B = r.params.length;
					n < B;
					++n
...
\u2028\u2029])`;
		...
		function m(C, I) {
			for (var c = C.replace(/^\/\*\*?/, ''), j = 0, U = new RegExp(iu, 'g'), d; (d = U.exec(c)); )
				if (((j += d[1].length), d.index + d[0].length > I + j)) return I + j + C.length - c.length;
		...
		(function (C) {
			...
			function b() {
				...
				return (
					(c += 1),
					s.code.isLineTerminator(i) && !(i === 13 && d.charCodeAt(c) === 10) && (j += 1),
					String.fromCharCode(i)
				);
			}
			function yu() {
				var i = '';
				for (b(); c < U && g(d.charCodeAt(c)); ) i += b();
				return i;
			}
			function ru() {
				var i,
				...
				for (n = !1; B < U; ) {
					if (
						((i = d.charCodeAt(B)),
						s.code.isLineTerminator(i) && !(i === 13 && d.charCodeAt(B + 1) === 10))
					)
						n = !0;
					else if (n) {
						if (i === 64) break;
			...
			function L(i, n, B) {
				for (var h, O, _, $, H = !1; c < n; )
					if (((h = d.charCodeAt(c)), s.code.isWhiteSpace(h))) b();
					else if (h === 123) {
						b();
						break;
					} else {
				...
				if (H) return null;
				for (O = 1, _ = ''; c < n; )
					if (((h = d.charCodeAt(c)), s.code.isLineTerminator(h))) b();
					else {
						if (h === 125) {
							if (((O -= 1), O === 0)) {
								b();
				...
				return O !== 0
					...
					: E(i)
					? e.parseParamType(_, { startIndex: N($), range: B })
					: e.parseType(_, { startIndex: N($), range: B });
			}
			function G(i) {
				var n;
				if (!s.code.isIdentifierStartES5(d.charCodeAt(c)) && !d[c].match(/[0-9]/)) return null;
				for (n = b(); c < i && s.code.isIdentifierPartES5(d.charCodeAt(c)); ) n += b();
				return n;
			}
			function K(i) {
				for (
					;
					c < i &&
					(s.code.isWhiteSpace(d.charCodeAt(c)) || s.code.isLineTerminator(d.charCodeAt(c)));
				...
				if (((h += G(i)), B))
					for (
						d.charCodeAt(c) === 58 &&
							...
							((h += b()), (h += G(i))),
							d.charCodeAt(c) === 91 && d.charCodeAt(c + 1) === 93 && ((h += b()), (h += b()));
						d.charCodeAt(c) === 46 ||
						d.charCodeAt(c) === 47 ||
						d.charCodeAt(c) === 35 ||
						d.charCodeAt(c) === 45 ||
				...
				if (O) {
					if ((K(i), d.charCodeAt(c) === 61)) {
						...
						for (var $, H = 1; c < i; ) {
							if (
								(($ = d.charCodeAt(c)),
								s.code.isWhiteSpace($) && (_ || (K(i), ($ = d.charCodeAt(c)))),
								$ === 39 && (_ ? _ === "'" && (_ = '') : (_ = "'")),
								$ === 34 && (_ ? _ === '"' && (_ = '') : (_ = '"')),
								$ === 91)
							)
								H++;
							else if ($ === 93 && --H === 0) break;
							h += b();
						}
					}
					if ((K(i), c >= i || d.charCodeAt(c) !== 93)) return null;
					h += b();
				}
				return h;
			}
			function gu() {
				for (; c < U && d.charCodeAt(c) !== 64; ) b();
				return c >= U ? !1 : (D.assert(d.charCodeAt(c) === 64), !0);
			}
			function N(i) {
			...
			(w.prototype.addError = function (n) {
				...
				(w.prototype.parseType = function () {
					if (p(this._title))
						try {
							...
							if (((this._tag.type = null), !this.addError(i.message))) return !1;
						}
				...
				(w.prototype._parseNamePath = function (i) {
					var n;
					return (
						(n = Fu(this._last, W && E(this._title), !0)),
				...
				(w.prototype.parseName = function () {
					...
					if (v(this._title))
						if (
							((this._tag.name = Fu(this._last, W && E(this._title), y(this._title))),
							this._tag.name)
						)
							(n = this._tag.name),
								n.charAt(0) === '[' &&
				...
				(w.prototype.parseCaption = function () {
					...
					return (
						O >= 0 && _ >= 0
							? ((this._tag.caption = n.substring(O + B.length, _).trim()),
				...
				(w.prototype.parseKind = function () {
					...
					return (
						...
						(n = t(d, c, this._last).trim()),
						(this._tag.kind = n),
						!(!F(B, n) && !this.addError("Invalid kind name '%0'", n))
					);
				}),
				...
				(w.prototype.parseThis = function () {
					...
					if (n && n.charAt(0) === '{') {
						...
						return (B && this._tag.type.type === 'NameExpression') ||
				...
				(w.prototype.parseVariation = function () {
					var n, B;
					return (
						(B = t(d, c, this._last).trim()),
						(n = parseFloat(B, 10)),
						(this._tag.variation = n),
						!(isNaN(n) && !this.addError("Invalid variation '%0'", B))
					);
				}),
				...
				(w.prototype.parse = function () {
					...
					for (
						...
						if (((O = h[n]), !this[O]())) return null;
					return this._tag;
				});
			function r(i) {
				var n, B, h;
				if (!gu()) return null;
				for (n = yu(), B = new w(i, n), h = B.parse(); c < B._last; ) b();
				return h;
			}
			function a(i) {
				var n = '',
				...
				for (h = !0; c < U && ((B = d.charCodeAt(c)), !(h && B === 64)); )
					s.code.isLineTerminator(B) ? (h = !0) : h && !s.code.isWhiteSpace(B) && (h = !1),
						(n += b());
				return i ? n : n.trim();
			}
			function f(i, n) {
				...
				if (
					(n === void 0 && (n = {}),
					typeof n.unwrap == 'boolean' && n.unwrap ? (d = M(i)) : (d = i),
					(eu = i),
					n.tags)
				)
					...
					else D.throwError('Invalid "tags" parameter: ' + n.tags);
				for (
					U = d.length,
						c = 0,
						j = 0,
						...
						W = n.sloppy,
						Au = n.strict,
						O = a(n.preserveWhitespace);
					(h = r(n)), !!h;

				)
					(!_ || _.hasOwnProperty(h.title)) && B.push(h);
				return { description: O, tags: B };
			}
			C.parse = f;
		})((A = {})),
			(u.version = D.VERSION),
...
var Dn = ((u) => (
	...
	nn = 'storybook/docs',
	yn = `${nn}/snippet-rendered`,
	sn = ((u) => ((u.AUTO = 'auto'), (u.CODE = 'code'), (u.DYNAMIC = 'dynamic'), u))(sn || {});
export {
	Wa as A,
	Ha as B,
	hn as C,
...
//# sourceMappingURL=index-e04ae519.js.map
