...
var c = {},
	i = l;
(c.createRoot = i.createRoot), (c.hydrateRoot = i.hydrateRoot);
var n = new Map(),
	D = ({ callback: t, children: e }) => {
		let r = a.useRef();
		return (
			a.useLayoutEffect(() => {
	...
	_ = async (t, e) => {
		...
		return new Promise((s) => {
			r.render(o.createElement(D, { callback: () => s(null) }, t));
		});
	},
	v = (t, e) => {
		let r = n.get(t);
		r && (r.unmount(), n.delete(t));
	},
	w = async (t) => {
		let e = n.get(t);
		return e || ((e = c.createRoot(t)), n.set(t, e)), e;
	},
	f = { code: E, a: R, ...x },
	...
	T = class {
		constructor() {
			(this.render = async (t, e, r) => {
				let s = { ...f, ...(e == null ? void 0 : e.components) },
					u = y;
							...
							_(
								o.createElement(
									...
									o.createElement(
										d,
										{ components: s },
										o.createElement(u, { context: t, docsParameter: e })
									)
								),
								r
							)
